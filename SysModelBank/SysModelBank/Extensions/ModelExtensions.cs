...
namespace SysModelBank.Extensions
{
    public static class ModelExtensions
    {
        ...
        public static IEnumerable<AccountModel> ToAccountsListModels(this ICollection<Account> accounts) =>
            accounts.Select(x => x.ToAccountModel());
        ...
        public static UserModel ToUserModel(this User user) =>
            new UserModel
            {
                ...
                Accounts = user.Accounts.ToAccountsListModels()
            };
    }
}
